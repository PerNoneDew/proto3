...
- UPDATE: anon + authenticated can update objects.
- DELETE: anon + authenticated can delete objects.
3. Notes
- The Function Hall cover image upload in Admin > Facilities and Services
  was failing because this bucket did not exist in the live database.
*/
